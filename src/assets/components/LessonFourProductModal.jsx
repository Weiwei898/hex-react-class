...
function LessonFourProductModal({ isOpen, type, tempProduct, getData, closeProductModal }) {
          ...
          <div className="modal-body p-4">
            <div className="row g-4">
              <div className="col-md-4">
                <div className="mb-4">
                  <label htmlFor="fileInput" className="form-label fw-bold text-secondary">上傳主要圖片</label>
                  <input ref={fileInputRef} type="file" className="form-control mb-2" id="fileInput" onChange={handleFileChange} />
                  
                  <label htmlFor="imageUrl" className="form-label fw-bold text-secondary">或輸入圖片網址</label>
              ...
              <div className="col-md-8">
                ...
                {/* 自訂欄位：星級 */}
                <div className="mb-3">
                  <label htmlFor="rating" className="form-label fw-bold text-secondary">商品評價 (1-5星)</label>
...
export default LessonFourProductModal;
