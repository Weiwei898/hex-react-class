...
import LessonSevenPagination from '../../components/LessonSevenPagination';
import './LessonSeven.css'; // 改用 LessonSeven 樣式

const API_BASE = import.meta.env.VITE_API_BASE;
const API_PATH = import.meta.env.VITE_API_PATH;

export default function LessonSevenProducts() {
  ...
  return (
    <div className="container mt-4 lesson-seven">
      <h2 className="mb-4 fw-bold text-white">產品列表</h2>
              ...
              <div className="card-body d-flex flex-column">
                ...
                <div className="mt-auto">
                  <div className="d-flex align-items-center mb-2">
                    <span className="text-white-50 me-2">評價</span>
                    {[...Array(5)].map((_, index) => (
                      <span key={index} className={index < (product.rating || 0) ? "text-warning" : "text-white-50"}>
                        ★
                      </span>
                    ))}
                  </div>
      ...
      <div className="d-flex justify-content-center mt-5">
        <LessonSevenPagination pageInfo={pageInfo} handlePageChange={getProducts} />
      </div>
    </div>
  );
}
