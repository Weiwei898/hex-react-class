...
import { useCart } from '../../hooks/lessonSixUseCart'; // 路徑修正
import LessonSixOrderForm from '../../components/LessonSixOrderForm'; // 路徑修正
import { validateOrderForm } from '../../utils/lessonSixValidateRules'; // 路徑修正
import './LessonSeven.css'; // 改用 LessonSeven 樣式

const API_BASE = import.meta.env.VITE_API_BASE;
const API_PATH = import.meta.env.VITE_API_PATH;

const LessonSevenCheckoutPage = () => { // 檔名與元件名一致
    ...
    <div className="container mt-4 lesson-seven">
      <div className="row mb-4">
        <div className="col-md-8 mx-auto d-flex align-items-center">
          <h2 className="fw-bold mb-0 text-white">填寫收件資訊</h2>
        </div>
      </div>
        ...
        <div className="col-md-8">
          ...
          {cart.carts && cart.carts.length > 0 && (
            <div className="card p-3 mb-4">
              <h5 className="card-title">訂單摘要</h5>
...
export default LessonSevenCheckoutPage;
